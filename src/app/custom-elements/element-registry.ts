...
export const ELEMENT_MODULE_LOAD_CALLBACKS_AS_ROUTES = [
  {
    ...
    loadChildren: () => import('./hello-world/hello-world.module').then(mod => mod.HelloWorldModule)
  }
];
...
export const ELEMENT_MODULE_LOAD_CALLBACKS_TOKEN = new InjectionToken<Map<string, LoadChildrenCallback>>('aee/elements-map');
